...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Dijon_Sales2</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="py-6 pl-2 text-gray-900">
                        ...
                        <section class="text-gray-600 body-font relative">
                                ...
                                <div class="flex">
                                    <div class="p-2 ">
                                        <Link as="button" :href="route('admin.data.data_menu')" class="w-40 flex mx-auto text-white bg-blue-500 border-0 h-10 py-2 pl-8 focus:outline-none hover:bg-blue-600 rounded text-ml">Data管理</Link>
                                    </div>
                                    <div class="flex ">
                                        <!-- ログアウトボタン -->
